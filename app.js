        ...
        (()=>{
            ...
            .then(function (registryResponse) {
                ...
                request.post({
                    ...
                    const convertResult = spawnSync('ffmpeg', ['-i ', __dirname + '/tmp/' + timeStamp + '.ogg', '-ac 1',  '-map 0:a', '-codec:a opus', '-b:a 128k', '-vbr off', '-ar 24000', __dirname + '/tmp/' + timeStamp + 'converted.ogg'])
